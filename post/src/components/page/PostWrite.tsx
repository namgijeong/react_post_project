...
function PostWrite() {
   ...
   const registerMutation = useMutationReactQuery<InputPost, Result | null>(['posts'], registerPost);

   const insertClick = async (inputContent: InputPost) => {
      // console.log('등록완료');
   ...
   return (
      <div css={DetailDivStyle}>
         ...
         <Box
            ...
            <Button sx={{ width: 150, height: 50 }} variant="contained" onClick={handleSubmit(insertClick)}>
               작성완료
            </Button>
         </Box>
      </div>
